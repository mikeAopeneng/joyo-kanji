...
#      do cp themename/$dpi/* /path/to/KanjiDroid/src/main/res/drawable-$dpi/
#   done
...
echo "for dpi in mdpi hdpi xhdpi xxhdpi; do cp ${themeName[$themeIndex]}-png/\$dpi/* /path/to/KanjiDroid/src/main/res/drawable-\$dpi/; done;"
