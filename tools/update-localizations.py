...
# Below is the list of official KanjiDroid localizations.
...
fileNames = ['01-core', '02-strings', '03-dialogs', '04-network', '05-feedback', '06-statistics', '07-cardbrowser', '08-widget', '09-backup', '10-preferences', '11-arrays', '14-marketdescription', '15-markettitle', '16-multimedia-editor']
anyError = False
titleFile = 'docs/marketing/localized_description/ankidroid-titles.txt'
titleString = 'KanjiDroid Flashcards'
...
for language in languages:
    ...
    valuesDirectory = "KanjiDroid/src/main/res/values-" + androidLanguage + "/"
...
subprocess.call("git add docs/marketing/localized_description KanjiDroid/src/main/res/values*", shell=True)
