#!/bin/bash
# Perform a release of KanjiDroid
# Nicolas Raoul 2011/10/24
# Timothy Rae 2014/11/10
# Usage from KanjiDroid's root directory:
...
cp KanjiDroid/build/outputs/apk/KanjiDroid-release.apk KanjiDroid-$VERSION.apk
...
github-release release --tag v$VERSION --name "KanjiDroid $VERSION" $PRE_RELEASE
github-release upload --tag v$VERSION --name KanjiDroid-$VERSION.apk --file KanjiDroid-$VERSION.apk
