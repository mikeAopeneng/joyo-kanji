...
echo "`jq '.short_name = "KanjiDroid" | .description = "__MSG_extDesc__"' cws/unpacked/manifest.json`" > cws/unpacked/manifest.json
...
DEFAULT_NAME='KanjiDroid Flashcards'
DEFAULT_DESC='Memorize anything with KanjiDroid!'
for LANG in $LANGS
do
