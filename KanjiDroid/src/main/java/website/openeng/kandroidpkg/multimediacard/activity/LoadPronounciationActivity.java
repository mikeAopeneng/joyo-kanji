...
import website.openeng.kandroidpkg.multimediacard.beolingus.parsing.BeolingusParser;
import website.openeng.kandroidpkg.multimediacard.language.LanguageListerBeolingus;
import website.openeng.kandroidpkg.runtimetools.TaskOperations;
import website.openeng.kandroidpkg.web.HttpFetcher;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static String EXTRA_SOURCE = "website.openeng.kandroidpkg.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static String EXTRA_PRONUNCIATION_FILE_PATH = "website.openeng.kandroidpkg.LoadPronounciationActivity.extra.pronun.file.path";
