...
import website.openeng.kandroidpkg.multimediacard.googleimagesearch.json.ImageSearchResponse;
import website.openeng.kandroidpkg.multimediacard.googleimagesearch.json.ResponseData;
import website.openeng.kandroidpkg.multimediacard.googleimagesearch.json.Result;
import website.openeng.kandroidpkg.web.HttpFetcher;
import website.openeng.kandroidpkg.web.UrlTools;
...
public class SearchImageActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public static String EXTRA_IMAGE_FILE_PATH = "website.openeng.kandroidpkg.search.image.activity.extra.image.file.path";
