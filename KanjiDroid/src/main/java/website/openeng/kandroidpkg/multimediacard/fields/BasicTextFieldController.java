...
package website.openeng.kandroidpkg.multimediacard.fields;
...
import website.openeng.kandroidpkg.multimediacard.activity.LoadPronounciationActivity;
import website.openeng.kandroidpkg.multimediacard.activity.PickStringDialogFragment;
import website.openeng.kandroidpkg.multimediacard.activity.SearchImageActivity;
import website.openeng.kandroidpkg.multimediacard.activity.TranslationActivity;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    /*
     * (non-Javadoc)
     * @see website.openeng.kandroidpkg.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started
