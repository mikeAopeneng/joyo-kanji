...
import website.openeng.kandroidpkg.dialogs.KanjiDroidCrashReportDialog;
...
@ReportsCrashes(
        ...
        additionalSharedPreferences = {"website.openeng.kandroidpkg"},
        ...
        logcatArguments = { "-t", "100", "-v", "time", "ActivityManager:I", "SQLiteLog:W", KanjiDroidApp.TAG + ":D", "*:S" }
)
public class KanjiDroidApp extends Application {

    public static final String XML_CUSTOM_NAMESPACE = "http://arbitrary.app.namespace/website.openeng.kandroidpkg";
    ...
    public static final String TAG = "KanjiDroid";
    // Singleton instance of this class.
    private static KanjiDroidApp sInstance;
    ...
    public void onCreate() {
        ...
        if (BuildConfig.DEBUG) {
            ...
            // Disable verbose error logging and use fixed log tag "KanjiDroid"
        ...
        // Create the KanjiDroid directory if missing. Send exception report if inaccessible.
        try {
            String dir = CollectionHelper.getCurrentKanjiDroidDirectory(this);
            CollectionHelper.initializeKanjiDroidDirectory(dir);
        } catch (StorageAccessException e) {
            Timber.e(e, "Could not initialize KanjiDroid directory");
            if (isSdCardMounted()) {
                sendExceptionReport(e, "KanjiDroidApp.onCreate");
            }
        }
    ...
    public static KanjiDroidApp getInstance() {
        return sInstance;
    }
