...
package website.openeng.kandroidpkg.services;
...
public class NotificationService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        Context context = KanjiDroidApp.getInstance().getBaseContext();
        ...
        if (dueCardsCount >= minimumCardsDueForNotification) {
            ...
            notification.setLatestEventInfo(appContext, contentTitle, tickerText, pendingKanjiDroidIntent);
