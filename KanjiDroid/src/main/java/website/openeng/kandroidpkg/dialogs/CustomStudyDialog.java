...
import website.openeng.kandroidpkg.StudyOptionsFragment;
...
public class CustomStudyDialog extends DialogFragment {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        ...
                        switch (choice) {
                            case CUSTOM_STUDY_NEW:
                                ...
                                try {
                                    KanjiDroidApp.getSharedPrefs(getActivity()).edit().putInt("extendNew", n).commit();
                            ...
                            case CUSTOM_STUDY_REV:
                                ...
                                try {
                                    KanjiDroidApp.getSharedPrefs(getActivity()).edit().putInt("extendRev", n).commit();
                                    JSONObject deck = col.getDecks().current();
    ...
    private String getDefaultValue() {
        SharedPreferences prefs = KanjiDroidApp.getSharedPrefs(getActivity());
        switch (getArguments().getInt("id")) {
            case CUSTOM_STUDY_NEW:
