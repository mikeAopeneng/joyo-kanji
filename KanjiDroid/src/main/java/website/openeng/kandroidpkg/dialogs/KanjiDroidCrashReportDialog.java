...
public class KanjiDroidCrashReportDialog extends BaseCrashReportDialog implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogBuilder.setPositiveButton(getText(ACRA.getConfig().resDialogPositiveButtonText()), KanjiDroidCrashReportDialog.this);
        dialogBuilder.setNegativeButton(getText(ACRA.getConfig().resDialogNegativeButtonText()), KanjiDroidCrashReportDialog.this);
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            if (autoReport) {
                preferences.edit().putString("reportErrorMode", KanjiDroidApp.FEEDBACK_REPORT_ALWAYS).commit();
                KanjiDroidApp.getInstance().setAcraReportingMode(KanjiDroidApp.FEEDBACK_REPORT_ALWAYS);
            }
