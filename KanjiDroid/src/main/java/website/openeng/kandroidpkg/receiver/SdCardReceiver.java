...
package website.openeng.kandroidpkg.receiver;
...
public class SdCardReceiver extends BroadcastReceiver {
    ...
    public static final String MEDIA_EJECT = "website.openeng.kandroidpkg.action.MEDIA_EJECT";
    public static final String MEDIA_MOUNT = "website.openeng.kandroidpkg.action.MEDIA_MOUNT";
