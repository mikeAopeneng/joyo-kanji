...
import website.openeng.kandroidpkg.dialogs.CardBrowserContextMenu;
import website.openeng.kandroidpkg.dialogs.CardBrowserMySearchesDialog;
import website.openeng.kandroidpkg.dialogs.CardBrowserOrderDialog;
...
import website.openeng.kandroidpkg.widgets.DeckDropDownAdapter;
...
import website.openeng.upgrade.Upgrade;
...
public class CardBrowser extends NavigationDrawerActivity implements
            ...
            if (which != mOrder) {
                ...
                try {
                    if (mOrder == 0) {
                        ...
                        KanjiDroidApp.getSharedPrefs(getBaseContext()).edit()
    ...
    private DialogFragment showDialogFragment(int id) {
        ...
        switch(id) {
            case DIALOG_TAGS:
                TagsDialog dialog = website.openeng.kandroidpkg.dialogs.TagsDialog.newInstance(
