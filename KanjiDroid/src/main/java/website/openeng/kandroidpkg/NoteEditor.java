...
import website.openeng.kandroidpkg.dialogs.NoteEditorRescheduleCard;
import website.openeng.kandroidpkg.dialogs.ConfirmationDialog;
import website.openeng.kandroidpkg.dialogs.TagsDialog;
import website.openeng.kandroidpkg.dialogs.TagsDialog.TagsDialogListener;
import website.openeng.kandroidpkg.exception.ConfirmModSchemaException;
import website.openeng.kandroidpkg.multimediacard.IMultimediaEditableNote;
import website.openeng.kandroidpkg.multimediacard.activity.MultimediaEditFieldActivity;
import website.openeng.kandroidpkg.multimediacard.fields.AudioField;
import website.openeng.kandroidpkg.multimediacard.fields.IField;
import website.openeng.kandroidpkg.multimediacard.fields.ImageField;
import website.openeng.kandroidpkg.multimediacard.impl.MultimediaEditableNote;
import website.openeng.kandroidpkg.receiver.SdCardReceiver;
import website.openeng.kandroidpkg.servicelayer.NoteService;
import website.openeng.async.DeckTask;
import website.openeng.filters.FilterFacade;
...
import website.openeng.widget.PopupMenuWithIcons;
...
//    public static final String TARGET_LANGUAGE = "TARGET_LANGUAGE";
    ...
    private DeckTask.TaskListener mSaveFactHandler = new DeckTask.TaskListener() {
        ...
        public void onProgressUpdate(DeckTask.TaskData... values) {
            ...
            if (mCaller == CALLER_BIGWIDGET_EDIT) {
                // KanjiDroidWidgetBig.setCard(values[0].getCard());
                // KanjiDroidWidgetBig.updateWidget(KanjiDroidWidgetBig.UpdateService.VIEW_NOT_SPECIFIED);
                mChanged = true;
            } else if (count > 0) {
                mChanged = true;
                mSourceText = null;
    ...
    protected void onCollectionLoaded(Collection col) {
        ...
        switch (mCaller) {
            ...
            case CALLER_BIGWIDGET_EDIT:
                // Card widgetCard = KanjiDroidWidgetBig.getCard();
                // if (widgetCard == null) {
                // finish();
                // return;
                // }
    ...
    private void showTagsDialog() {
        ...
        TagsDialog dialog = website.openeng.kandroidpkg.dialogs.TagsDialog.newInstance(TagsDialog.TYPE_ADD_TAG, selTags,
                tags);
