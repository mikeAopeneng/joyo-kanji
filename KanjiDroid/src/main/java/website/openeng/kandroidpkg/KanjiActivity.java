...
import website.openeng.kandroidpkg.dialogs.SimpleMessageDialog;
...
public class KanjiActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Collection>,
    ...
    public void showAsyncDialogFragment(AsyncDialogFragment newFragment) {
        try {
            ...
            // Store a persistent message to SharedPreferences instructing KanjiDroid to show dialog
    ...
    protected void showSimpleNotification(String title, String message) {
        SharedPreferences prefs = KanjiDroidApp.getSharedPrefs(this);
        ...
        if (Integer.parseInt(prefs.getString("minimumCardsDueForNotification", "0")) <= 1000000) {
            // Use the title as the ticker unless the title is simply "KanjiDroid"
            String ticker = title;
