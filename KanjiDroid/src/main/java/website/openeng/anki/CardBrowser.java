...
import website.openeng.anki.dialogs.CardBrowserContextMenu;
import website.openeng.anki.dialogs.CardBrowserMySearchesDialog;
import website.openeng.anki.dialogs.CardBrowserOrderDialog;
...
public class CardBrowser extends NavigationDrawerActivity implements
    ...
    private DialogFragment showDialogFragment(int id) {
        ...
        switch(id) {
            case DIALOG_TAGS:
                TagsDialog dialog = website.openeng.anki.dialogs.TagsDialog.newInstance(
