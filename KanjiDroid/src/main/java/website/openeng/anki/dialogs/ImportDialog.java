    ...
    public MaterialDialog onCreateDialog(Bundle savedInstanceState) {
        ...
        switch (mType) {
            case DIALOG_IMPORT_HINT:
                // Instruct the user that they need to put their APKG files into the KanjiDroid directory
                return builder.title(res.getString(R.string.import_title))
                        .content(res.getString(R.string.import_hint, CollectionHelper.getCurrentKanjiDroidDirectory(getActivity())))
