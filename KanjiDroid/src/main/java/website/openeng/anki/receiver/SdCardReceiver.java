...
package website.openeng.anki.receiver;
...
public class SdCardReceiver extends BroadcastReceiver {
    ...
    public static final String MEDIA_EJECT = "website.openeng.anki.action.MEDIA_EJECT";
    public static final String MEDIA_MOUNT = "website.openeng.anki.action.MEDIA_MOUNT";
