...
import website.openeng.anki.multimediacard.activity.LoadPronounciationActivity;
import website.openeng.anki.multimediacard.activity.PickStringDialogFragment;
import website.openeng.anki.multimediacard.activity.SearchImageActivity;
import website.openeng.anki.multimediacard.activity.TranslationActivity;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    /*
     * (non-Javadoc)
     * @see website.openeng.anki.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started
