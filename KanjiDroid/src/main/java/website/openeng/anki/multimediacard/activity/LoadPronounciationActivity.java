...
package website.openeng.anki.multimediacard.activity;
...
import website.openeng.anki.multimediacard.beolingus.parsing.BeolingusParser;
import website.openeng.anki.multimediacard.language.LanguageListerBeolingus;
import website.openeng.anki.runtimetools.TaskOperations;
import website.openeng.anki.web.HttpFetcher;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static String EXTRA_SOURCE = "website.openeng.anki.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static String EXTRA_PRONUNCIATION_FILE_PATH = "website.openeng.anki.LoadPronounciationActivity.extra.pronun.file.path";
