...
import website.openeng.anki.multimediacard.googleimagesearch.json.ImageSearchResponse;
import website.openeng.anki.multimediacard.googleimagesearch.json.ResponseData;
import website.openeng.anki.multimediacard.googleimagesearch.json.Result;
import website.openeng.anki.web.HttpFetcher;
import website.openeng.anki.web.UrlTools;
...
public class SearchImageActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public static String EXTRA_IMAGE_FILE_PATH = "website.openeng.anki.search.image.activity.extra.image.file.path";
