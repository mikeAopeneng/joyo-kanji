...
public class LanguageUtil {
    ...
    /** A list of all languages supported by KanjiDroid */
    ...
    public static Locale getLocale(String localeCode) {
        ...
        if (localeCode == null || TextUtils.isEmpty(localeCode)) {
            ...
            localeCode = KanjiDroidApp.getSharedPrefs(KanjiDroidApp.getInstance().getBaseContext()).getString(
