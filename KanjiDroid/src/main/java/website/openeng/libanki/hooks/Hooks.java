...
package website.openeng.libanki.hooks;
...
import website.openeng.libanki.LaTeX;
...
public class Hooks {
    ...
    public static Object runFilter(String hook, Object arg, Object... args) {
        if (hooks == null) {
            ...
            KanjiDroidApp.sendExceptionReport(new IllegalStateException("Hooks object uninitialized"), "Hooks.runFilter");
            return arg;
        }
        List<Hook> _hook = hooks.get(hook);
        String funcName = "";
