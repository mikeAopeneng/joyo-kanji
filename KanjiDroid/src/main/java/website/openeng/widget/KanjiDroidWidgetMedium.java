...
public class KanjiDroidWidgetMedium extends AppWidgetProvider {
    ...
    public static class UpdateService extends Service {
        ...
        private static final String ACTION_NEXT = "org.ichi2.anki.KanjiDroidWidget.NEXT";

        /**
         * If this action is used when starting the service, it will move to the previous due deck.
         */
        private static final String ACTION_PREV = "org.ichi2.anki.KanjiDroidWidget.PREV";
         ...
         */
        private static final String ACTION_IGNORE = "org.ichi2.anki.KanjiDroidWidget.IGNORE";

        /**
         * If this action is used when starting the service, it will open the current due deck.
         */
        private static final String ACTION_OPEN = "org.ichi2.anki.KanjiDroidWidget.OPEN";

        /**
         * Update the state of the widget.
         */
        public static final String ACTION_UPDATE = "org.ichi2.anki.KanjiDroidWidget.UPDATE";
        ...
        public void onStart(Intent intent, int startId) {
            ...
            if (intent != null) {
                ...
                if (ACTION_NEXT.equals(intent.getAction())) {
                    ...
                    Timber.d("KanjiDroidWidget.UpdateService: UPDATE");
                }
            }
            RemoteViews updateViews = buildUpdate(this, updateDueDecksNow);

            ComponentName thisWidget = new ComponentName(this, KanjiDroidWidgetMedium.class);
