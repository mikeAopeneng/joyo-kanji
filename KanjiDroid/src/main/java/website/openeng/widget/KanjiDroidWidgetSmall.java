...
public class KanjiDroidWidgetSmall extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().contentEquals("com.sec.android.widgetapp.APPWIDGET_RESIZE")) {
            CompatHelper.getCompat().updateWidgetDimensions(context, new RemoteViews(context.getPackageName(), R.layout.widget_small), KanjiDroidWidgetSmall.class);
        }
    ...
    public static class UpdateService extends Service {
        ...
        public void onStart(Intent intent, int startId) {
            ...
            ComponentName thisWidget = new ComponentName(this, KanjiDroidWidgetSmall.class);
        ...
        private RemoteViews buildUpdate(Context context, boolean updateDueDecksNow) {
            ...
            boolean mounted = KanjiDroidApp.isSdCardMounted();
            if (!mounted) {
