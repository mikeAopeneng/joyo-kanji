    ...
    private static class UpdateDeckStatusAsyncTask extends BaseAsyncTask<Context, Void, Context> {
        ...
        protected Context doInBackground(Context... params) {
            ...
            try {
                ...
                // float progress;
                // if (col == null) {
                // col = Collection.openCollection(KanjiDroidApp.getCollectionPath());
        ...
        protected void onPostExecute(Context context) {
            ...
            // if (mediumWidget) {
            // Intent intent;
            // intent = new Intent(context, KanjiDroidWidgetMedium.UpdateService.class);
            // intent.setAction(KanjiDroidWidgetMedium.UpdateService.ACTION_UPDATE);
            // context.startService(intent);
            // }
            if (smallWidget) {
                Intent intent;
                intent = new Intent(context, KanjiDroidWidgetSmall.UpdateService.class);
                context.startService(intent);
            }
            // if (bigWidget) {
            // Intent intent;
            // intent = new Intent(context, KanjiDroidWidgetBig.UpdateService.class);
            // intent.setAction(KanjiDroidWidgetBig.UpdateService.ACTION_UPDATE);
            // context.startService(intent);
            // }
            if (notification) {
                Intent intent;
