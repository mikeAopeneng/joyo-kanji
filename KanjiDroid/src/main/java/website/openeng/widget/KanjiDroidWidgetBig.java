...
//
//public class KanjiDroidWidgetBig extends AppWidgetProvider {
//
...
//                    && KanjiDroidApp.getSharedPrefs(KanjiDroidApp.getInstance().getBaseContext()).getLong(
...
//            // show info dialog
//            Intent intent;
//            intent = new Intent(context, KanjiDroidWidgetBig.UpdateService.class);
...
//                .startService(
//                        getUpdateIntent(KanjiDroidApp.getInstance().getApplicationContext(), view, showProgressDialog));
//    }
//
//
//    public static Intent getUpdateIntent(Context context, int view, boolean showProgressDialog) {
//        Intent intent = new Intent(context, KanjiDroidWidgetBig.UpdateService.class);
...
//        public static final String ACTION_NOTHING = "org.ichi2.anki.KanjiDroidWidgetBig.NOTHING";
//        public static final String ACTION_OPENDECK = "org.ichi2.anki.KanjiDroidWidgetBig.OPENDECK";
//        public static final String ACTION_OPENCOLLECTION = "org.ichi2.anki.KanjiDroidWidgetBig.OPENCOLLECTION";
//        public static final String ACTION_CLOSEDECK = "org.ichi2.anki.KanjiDroidWidgetBig.CLOSEDECK";
//        public static final String ACTION_ANSWER = "org.ichi2.anki.KanjiDroidWidgetBig.ANSWER";
//        public static final String ACTION_OPEN = "org.ichi2.anki.KanjiDroidWidgetBig.OPEN";
//        public static final String ACTION_UPDATE = "org.ichi2.anki.KanjiDroidWidgetBig.UPDATE";
//        public static final String ACTION_BURY_CARD = "org.ichi2.anki.KanjiDroidWidgetBig.BURYCARD";
//        public static final String ACTION_UNDO = "org.ichi2.anki.KanjiDroidWidgetBig.UNDO";
//        public static final String ACTION_CARDEDITOR = "org.ichi2.anki.KanjiDroidWidgetBig.CARDEDITOR";
//        public static final String ACTION_FACTADDER = "org.ichi2.anki.KanjiDroidWidgetBig.FACTADDER";
//        public static final String ACTION_HELP = "org.ichi2.anki.KanjiDroidWidgetBig.HELP";
//        public static final String ACTION_SHOW_RESTRICTIONS_DIALOG = "org.ichi2.anki.KanjiDroidWidgetBig.SHOWRESTRICTIONSDIALOG";
//        public static final String ACTION_LEARN_MORE = "org.ichi2.anki.KanjiDroidWidgetBig.LEARNMORE";
//        public static final String ACTION_REVIEW_EARLY = "org.ichi2.anki.KanjiDroidWidgetBig.REVIEWEARLY";
//        public static final String ACTION_SHOW_TOMORROW_DUES = "org.ichi2.anki.KanjiDroidWidgetBig.TOMORROWDUES";
//
...
//            public void onPostExecute(DeckTask.TaskData result) {
//                contentService.mCol = null;
//                KanjiDroidApp.getSharedPrefs(UpdateService.this.getBaseContext()).edit().putString("lastWidgetDeck", "")
//                        .commit();
//                contentService.setCard(null);
//                contentService.mBigShowProgressDialog = false;
//                contentService.mBigCurrentMessage = null;
...
//                                new DeckTask.TaskData(KanjiDroidApp.getCollectionPath()));
//                        updateViews();
//                    } else {
//                        showDeckSelectionDialog();
//                    }
...
//                        getTomorrowDuesAsyncTask.execute(KanjiDroidApp.getSharedPrefs(
//                                KanjiDroidWidgetBig.UpdateService.this).getString("deckPath",
//                                KanjiDroidApp.getStorageDirectory() + "/KanjiDroid"));
//                    } else {
...
//            // TODO
//            // Intent newIntent = DeckPicker.getLoadDeckIntent(KanjiDroidWidgetBig.UpdateService.this, 0);
...
//
//            ComponentName thisWidget = new ComponentName(this, KanjiDroidWidgetBig.class);
