...
public class NumberRangePreference extends EditTextPreference {
    ...
    private int getMinFromAttributes(AttributeSet attrs) {
        return attrs == null ? 0 : attrs.getAttributeIntValue(KanjiDroidApp.XML_CUSTOM_NAMESPACE, "min", 0);
    }
    ...
    private int getMaxFromAttributes(AttributeSet attrs) {
        return attrs == null ? Integer.MAX_VALUE : attrs.getAttributeIntValue(KanjiDroidApp.XML_CUSTOM_NAMESPACE, "max",
                Integer.MAX_VALUE);
    }
