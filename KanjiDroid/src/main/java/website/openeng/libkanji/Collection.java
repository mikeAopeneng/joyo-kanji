        ...
        try {
            ...
            for (Pair<String, String> p : new Pair[]{new Pair<String, String>("q", qfmt), new Pair<String, String>("a", afmt)}) {
                ...
                if (type.equals("q")) {
                    ...
                    // the following line differs from libkanji // TODO: why?
    ...
    public long fixIntegrity() {
        ...
        try {
            ...
            try {
                ...
                // DB must have indices. Older versions of KanjiDroid didn't create them for new collections.
            ...
            KanjiDroidApp.sendExceptionReport(e, "doInBackgroundCheckDatabase");
            return -1;
        }
