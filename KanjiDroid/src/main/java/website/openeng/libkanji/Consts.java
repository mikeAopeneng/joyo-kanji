...
public class Consts {
    ...
    public static final String SYNC_BASE = "https://openeng.website/";
    public static final String SYNC_MEDIA_BASE = "https://msync.openeng.website/";
    public static final int SYNC_VER = 8;

    public static final String HELP_SITE = "http://ankisrs.net/docs/manual.html";

    // The labels defined in consts.py are in KanjiDroid's resources files.
}
