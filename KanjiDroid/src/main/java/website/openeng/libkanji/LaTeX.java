...
import website.openeng.libkanji.hooks.Hook;
 ...
 * 3 - [$$]...[$$]
 *
 * Unlike the original python implementation of this class, the KanjiDroid version does not support
...
public class LaTeX {
     ...
     * in KanjiDroid. The omitted parameters are used to generate LaTeX images. KanjiDroid does not
