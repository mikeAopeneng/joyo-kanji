package website.openeng.libkanji.hooks;
...
public class ExternalHookLoader {   
     ...
     * @param String colPath : path to KanjiDroid collection. Hook plugins should go in ~/plugins/hooks as compiled apk or jar packages
     */
